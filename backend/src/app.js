...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            defaultSrc: ["'self'"],
            connectSrc: ["'self'", "https://*.googleapis.com", "https://*.gstatic.com", "https://api.dicebear.com", "https://*.unsplash.com", "https://images.unsplash.com", "https://*.openstreetmap.org", "https://viacep.com.br"],
